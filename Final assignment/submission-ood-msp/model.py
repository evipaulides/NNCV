...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        include = self.detect_ood(logits)
        return logits, include.item() # Return the segmentation logits and a boolean indicating that the image is in-distribution (not OOD)
